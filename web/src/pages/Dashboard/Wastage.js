...
class TableList extends PureComponent {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            <FormItem label="Flight">
              {getFieldDecorator('flightNo')(<Input placeholder="Search Flight" />)}
            </FormItem>
          </Col>
          <Col md={8} sm={24}>
            <FormItem label="Date">
              {getFieldDecorator('date')(
                <DatePicker style={{ width: '100%' }} placeholder="Search Date" />
              )}
            </FormItem>
          </Col>
          <Col md={8} sm={24}>
            <FormItem label="Name">
              {getFieldDecorator('name')(<Input placeholder="Search item" />)}
            </FormItem>
          </Col>
        </Row>
      </Form>
  ...
  render() {
    const { selectedRows, modalVisible, updateModalVisible, stepFormValues, data } = this.state;
    const parentMethods = {
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  render: timestamp => moment(timestamp * 1000).format('YYYY-MM-DD, ddd ha'),
                },
                {
                  title: 'Name',
                  dataIndex: 'name',
                ...
                },
                {
                  title: 'Uplift Qty',
                  dataIndex: 'upliftQty',
                  sorter: (a, b) => a.upliftQty - b.upliftQty,
                },
                {
                  title: 'Wastage (%)',
                  dataIndex: 'qty',
